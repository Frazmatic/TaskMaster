...
public final class Task implements Model {
  ...
  private Task(String id, String title, String body, TaskState state, Temporal.DateTime created) {
    this.id = id;
    this.title = title;
    this.body = body;
    this.state = state;
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String title, String body, TaskState state, Temporal.DateTime created) {
      super.id(id);
      super.title(title)
        .body(body)
        .state(state)
